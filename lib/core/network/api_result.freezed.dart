...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(failure_model.Failure failure) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(failure_model.Failure failure)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({failure_model.Failure failure});
}
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  final failure_model.Failure failure;
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure(final failure_model.Failure failure) = _$FailureImpl<T>;

  failure_model.Failure get failure;
  @JsonKey(ignore: true)
  _$$FailureImplCopyWith<T, _$FailureImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
